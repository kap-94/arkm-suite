...
class FlowParticle {
  ...
  update(cursor: Vector, width: number, height: number, time: number) {
    ...
    // Interacción con el cursor - usando el comportamiento de ParticlesNetwork (repeler en lugar de atraer)
...
export default function FlowParticles({
  ...
  useEffect(() => {
    ...
    const drawConnections = (particles: FlowParticle[]) => {
    ...
    const animate = (timestamp: number) => {
      ...
      // Dibujamos las conexiones entre partículas
